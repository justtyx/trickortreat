...
let candySound= document.querySelector('#candy_sound');
let veggieSound = document.querySelector('#veggie_sound');
let heartSound = document.querySelector('#heart_sound');
let backgroundMusic = document.querySelector('#BG_music');
...
function openSettingsScreen() {
    ...
    document.querySelector('#replay_button').addEventListener('mouseup', activateReplayButton);
...
function playSound() {
    if (soundIsOn === true) {
        ...
        candySound.muted = true;
        veggieSound.muted = true;
        ...
        candySound.muted = false;
        veggieSound.muted = false;
...
function activateReplayButton() {
    console.log('activateReplayButton');
    console.log(this);

    this.removeEventListener('mouseup', activateReplayButton);
...
function openGameOver() {
    ...
    document.querySelector('#game_over_screen').classList.remove('hidden');
    document.querySelector('#GO_replay_button').addEventListener('mouseup', activateReplayButton);
...
function openLevelComplete() {
    ...
    document.querySelector('#game_over_screen').classList.remove('hidden');
    document.querySelector('#LC_replay_button').addEventListener('mouseup', activateReplayButton);
